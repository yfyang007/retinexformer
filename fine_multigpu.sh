...
# pytorch2.x
CUDA_VISIBLE_DEVICES=$gpu_ids torchrun --nproc_per_node=$gpu_count --master_port=$master_port basicsr/finetune.py --opt $config --launcher pytorch --pretrained_weights $pretrained_weights